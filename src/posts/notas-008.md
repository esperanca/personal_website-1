...
1. Identidade digital do gov.br e a posterior integração do conta gov.br com o site do poupatempo
2. App para carteira de motorista
3. Número único da Carteira de Identidade Nacional
4. A mudança no processo de integração de dados dos Detrans
5. A camada digital do ambiente do poupatempo com o app, ligando o agendamento com a fila física
6. O treinamento do time do Poupatempo para ativamente prever erros e ajudar com tecnologia
