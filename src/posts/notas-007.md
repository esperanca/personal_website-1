...
Uma das contribuições do Test-Driven Development foi inverter uma sequência que parecia natural. Em vez de implementar primeiro e testar depois, escrevemos uma expectativa verificável antes da implementação. O ciclo ficou conhecido:
